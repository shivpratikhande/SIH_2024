  ...
  const handleSearchClick = () => {
    setFilteredClients(
      clients.filter(client =>
        client.case_id.toUpperCase().includes(searchTerm.toUpperCase()) ||
        ...
        {filteredClients.length === 0 ? (
          ...
          filteredClients.map(client => (
            <div key={client.id} className="bg-white shadow-md rounded-lg p-4 flex flex-col transition-transform transform hover:scale-105 hover:shadow-lg">
              <h2 className="text-xl font-semibold mb-2 text-left">{client.name}</h2>
              <p className="text-gray-700 mb-1 text-left"><span className="font-medium">Case ID:</span> {client.case_id}</p>
              ...
              <p className="text-gray-600 mb-1 text-left"><span className="font-medium">Email:</span> {client.email_id}</p>
              <p className="text-gray-600 mb-1 text-left"><span className="font-medium">Phone:</span> {client.phone_no}</p>
