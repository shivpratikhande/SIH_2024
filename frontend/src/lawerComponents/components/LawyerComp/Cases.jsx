...
const Cases = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      {/* Heading Section */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2 text-gray-800 text-left">
          Cases
        </h1>
        <p className="text-lg text-gray-600 text-left">
          Here you can view and manage all the cases.
        </p>
      </div>
