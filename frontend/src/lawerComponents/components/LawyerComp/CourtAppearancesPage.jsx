...
import { FaCalendarAlt, FaClock, FaMapMarkerAlt, FaUser, FaGavel, FaStickyNote, FaSearch } from 'react-icons/fa';
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="text-left mb-8">
        <h1 className="text-4xl font-bold mb-4 text-gray-800">Court Appearances</h1>
        <p className="text-lg text-gray-600">Search for court appearances based on case details.</p>
      </div>
              ...
              <div className="p-6">
                ...
                <div className="text-gray-700 mb-4">
                  <div className="flex items-center mb-3">
                    ...
                    <div>
                      <span className="font-medium">Date:</span> {appearance.date}
                    </div>
                  </div>
                  <div className="flex items-center mb-3">
                    <FaClock className="mr-3 text-primary" />
                    <div>
                      <span className="font-medium">Time:</span> {appearance.time}
                    </div>
                  </div>
                  <div className="flex items-center mb-3">
                    <FaMapMarkerAlt className="mr-3 text-primary" />
                    <div>
                      <span className="font-medium">Location:</span> {appearance.location}
                    </div>
                  </div>
                  <div className="flex items-center mb-3">
                    <FaUser className="mr-3 text-primary" />
                    <div>
                      <span className="font-medium">Attorney:</span> {appearance.attorney}
                    </div>
                  </div>
                  <div className="flex items-center mb-4">
                    <FaGavel className="mr-3 text-primary" />
                    <div>
                      <span className="font-medium">Judge:</span> {appearance.judge}
                    </div>
                  </div>
                </div>
                <div className="text-gray-700">
                  <div className="flex items-start">
                    ...
                    <div>
                      <span className="font-medium">Notes:</span> {appearance.notes}
                    </div>
                  </div>
                </div>
              </div>
